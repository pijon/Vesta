        ...
        >
          ...
          <div className="p-6">
            {recentWorkouts && recentWorkouts.length > 0 && !editingWorkout && (
              <div className="mb-6">
                <label className="block text-xs font-bold text-charcoal/60 dark:text-stone-400 uppercase tracking-wider mb-3">Quick Add</label>
            ...
            <div className="space-y-5">
              <div>
                <label className="block text-sm font-bold text-charcoal dark:text-stone-200 mb-2">Workout Type</label>
                <input
                  type="text"
                  value={workoutType}
                  onChange={(e) => setWorkoutType(e.target.value)}
                  onKeyDown={(e) => e.key === 'Enter' && handleSave()}
                  className="w-full p-3 bg-white dark:bg-white/5 border border-transparent focus:border-workout/50 rounded-xl focus:ring-2 focus:ring-workout/20 outline-none font-medium text-charcoal dark:text-stone-200 placeholder:text-charcoal/40 dark:placeholder:text-stone-600"
              ...
              <div>
                <label className="block text-sm font-bold text-charcoal dark:text-stone-200 mb-2">Calories Burned</label>
                <input
                  type="number"
                  ...
                  placeholder="e.g. 200"
                />
                <p className="text-xs text-charcoal/60 dark:text-stone-400 mt-2 ml-1">Estimate based on duration and intensity</p>
              </div>
            </div>
          </div>
